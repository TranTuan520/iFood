...
import {Text, View, Dimensions, Image, TouchableOpacity, StyleSheet, FlatList} from 'react-native';
import FontAwesome from 'react-native-vector-icons/FontAwesome';
import {COLORS, FONTS} from '../constants/theme';
const {width, height} = Dimensions.get('window');

const RenderFoodCartScreen = ({navigation, Foods}) => {
    ...
    const RenderItem = ({item}) =>{
        ...
        onPress={() => {
          navigation.navigate('FoodDetail', {food: item});
             ...
             <Image
            source={{uri: item.value.FoodImage}}
...
//             <Text
//               numberOfLines={2}
//               style={{fontSize: 20, flex: 1, elevation: 4}}>
//               dfcdfdf edf
//             </Text>
//           </View>
//           {/* Price && Buttons */}
