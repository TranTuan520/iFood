...
export class EditFood extends Component {
  ...
  uploadImage = async () => {
    ...
    this.setState({
      FoodImage: (
        await storage().ref(`/ImageFood/${fileName}`).getDownloadURL()
      ).toString(),
    });
      ...
      <ScrollView>
        <View
          ...
          <TextInput
            ...
            onChangeText={(FoodPrice) => {
              this.setState({FoodPrice});
            }}
          />
...
const styles = StyleSheet.create({
  ...
  buttonText: {fontSize: 22, color: 'white', padding: 8},
});
